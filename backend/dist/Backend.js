...
app.put('/users/id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield db_1.default.query('UPDATE users SET display_name = $1, email = $2 WHERE user_id = $3', [
            display_name,
            email,
            user_id,
        ]);
...
app.post('/plant_types', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newPlantType = yield db_1.default.query('INSERT INTO plant_types (plant_name) VALUES ($1);', [
            plant_name,
        ]);
...
app.get('/plant_types/id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const plantType = yield db_1.default.query('SELECT * FROM plant_types WHERE plant_type_id = $1', [
            plant_type_id,
        ]);
...
app.put('/plant_types/id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield db_1.default.query('UPDATE plant_types SET plants_name = $1 WHERE plant_type_id = $2', [
            plant_name,
            plant_type_id,
        ]);
